...
def backup(path: Path) -> Path:
    b = path.with_suffix(path.suffix + f".bak_diagfix_{STAMP}")
...
def physics_diagnostics(df, target_col=None, time_col=None):
    ...
    try:
        ...
        # If dt_seconds is suspiciously small/invalid, recompute from t
        ...
        # Derivatives: use t directly (works for irregular spacing)
        ...
        # Normalize score field name if your constraints function uses a different key
        score = 0.0
...
def main():
    ...
    print("[OK] physics_diagnostics patched + compiled clean")
    print(" - file:", PHYSICS)
    print(" - backup:", b)
